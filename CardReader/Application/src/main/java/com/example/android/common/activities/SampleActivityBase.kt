...
open class SampleActivityBase : FragmentActivity() {
    ...
    /**
     * Set up targets to receive log data. We initialize `LogWrapper logWrapper` and set it to
     * be the LogNode that data will be sent to. We then log the message "Ready"
     *
     */
