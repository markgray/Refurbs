...
open class SampleActivityBase : FragmentActivity() {
    ...
    /**
     * Set up targets to receive log data. We initialize [LogWrapper] variable `val logWrapper`
     * to a new instance and set it to be the [LogNode] that data will be sent to. We then log the
     * message "Ready"
     */
