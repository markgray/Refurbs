...
class MainActivity : SampleActivityBase() {
     ...
     * [FloatingActionButtonBasicFragment] variable `val fragment` with a new instance and use
     ...
     * [FloatingActionButtonBasicFragment] fragment, if not `null` we are being recreated after
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState == null) {
            ...
            val fragment = FloatingActionButtonBasicFragment()
     ...
     * the value of [Boolean] flag fiedl [mLogShown], then initialize [ViewAnimator] variable
