...
class MainActivity : AppCompatActivity() {
     ...
     * `android.R.id.content` then call [ViewCompat.setOnApplyWindowInsetsListener]
     ...
     * [WindowInsetsCompat.CONSUMED] to the caller (so that the window insets will
     * not keep passing down to descendant views).
     *
