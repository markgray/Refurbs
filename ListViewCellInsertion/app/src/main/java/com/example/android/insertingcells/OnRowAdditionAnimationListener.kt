 ...
 */
interface OnRowAdditionAnimationListener {
    /**
     * Called when the animation of a new row addition begins.
     */
    fun onRowAdditionAnimationStart()

    /**
     * Called when the animation of a new row addition ends.
     */
    fun onRowAdditionAnimationEnd()
}