 ...
 * `OnTouchListener listener` in our field `mTouchListener`. In our `init` block we loop over
 * `int i` for all of the strings in our parameter `List<String> objects` storing `i` under the
