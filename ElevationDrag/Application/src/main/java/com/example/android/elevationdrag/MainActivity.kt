...
class MainActivity : SampleActivityBase() {
     ...
     * [ViewGroup.MarginLayoutParams] with the left margin set to `insets.left`, the right
     * margin set to `insets.right`, the top margin set to `insets.top`, and the bottom margin
     * set to `insets.bottom`. Finally it returns [WindowInsetsCompat.CONSUMED] to the caller
     ...
     * [ElevationDragFragment] variable `val fragment` with a new instance and use `transaction`
     ...
     *
     * @param savedInstanceState If this is `null` we need to create and add our [ElevationDragFragment]
