...
class MainActivity : SampleActivityBase() {
     ...
     * `R.id.sample_main_layout` then call [ViewCompat.setOnApplyWindowInsetsListener] to take over
     ...
     * [RevealEffectBasicFragment] variable `val fragment` with a new instance and use
     ...
     * this context to inflate our menu layout file `R.menu.main` (which contains one [MenuItem]
     ...
     * `R.id.sample_output` is an instance of [ViewAnimator] (screens less than 720dp wide), and
     * set its title to `R.string.sample_hide_log` ("Hide Log") if our [Boolean] flag field
