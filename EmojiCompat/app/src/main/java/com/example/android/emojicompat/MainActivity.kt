...
class MainActivity : AppCompatActivity() {
    ...
    private class InitCallback(regularTextView: TextView) : EmojiCompat.InitCallback() {
         ...
         * variable `TextView regularTextView` with the referent of the weak reference to the
         * TextView stored in `mRegularTextViewRef`. If this is not null we initialize our
         * variable `EmojiCompat compat` with the singleton EmojiCompat instance, and our
         * variable `Context context` with the context of `regularTextView`. Finally we
         * set the tex of `regularTextView` to the `CharSequence` returned by the
         * `process` method of `compat` after it processes the string generated by the
         * `getString` method of `context` from the format R.string.regular_text_view and
         * the format argument EMOJI.
         */
