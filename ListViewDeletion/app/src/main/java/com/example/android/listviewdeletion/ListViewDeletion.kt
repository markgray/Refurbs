...
class ListViewDeletion : ComponentActivity() {
     ...
     * by finding the view with id `R.id.usePositionsCB` ("Use Positions"), and initialize [ListView]
     * variable `val listView` by finding the view with id `R.id.list_view`. We initialize [ArrayList]
     * of [String] variable `val cheeseList` with a new instance, and add all the strings in
