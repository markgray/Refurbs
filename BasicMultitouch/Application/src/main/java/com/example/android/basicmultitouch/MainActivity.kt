...
class MainActivity : AppCompatActivity() {
     ...
     * content view to our layout file `R.layout.layout_mainactivity` (this layout file contains
     * a [TouchDisplayView] widget overlayed over a [TextView] in a shared [FrameLayout]).
     *
